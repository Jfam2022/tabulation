...
<meta charset="utf-8"> 
    ...
    <title>ST ROSE COLLEGE EDUCATIONAL FOUNDATION INC. VOTE PERCENTAGE</title>
<body>
<!--header-->
    ...
    <div class="header container">
           ...
           <div class="nav-list">
            <div class="hamburger"><div class="bar"></div></div>
             <ul>
             <li><a href="{{ url('/voteleading')}}" data-after="HOME">GET WINNERS</a></li>
...
<H2 style="text-align:center; color:white; margin-top:10px; margin-bottom:10px;">TOTAL COUNT OF VOTES</H2>

<div class="hero_container">
<div class="box1">
    <div class="title">FEMALE CANDIDATES TOTAL VOTES:  <span class="totalvotes">{{$totalvotefemale}}</span></div>
   ...
   <td align="center"  data-title="TASK">
            <a href="{{ url('editvoteadmin/' .$female['id'])}}" type="button" class="btn btn-primary " >EDIT</a>&nbsp&nbsp
    ...
    <div class="box">
  <div class="title">MALE CANDIDATES TOTAL VOTES: <span class="totalvotes"> {{$totalvotemale}}</span></div>
  ...
  <td align="center"  data-title="TASK" style="width:50px; " >
           <a href="{{ url('editvoteadmin/' .$male['id'])}}"type="button" class="btn btn-primary " >EDIT</a>&nbsp&nbsp
