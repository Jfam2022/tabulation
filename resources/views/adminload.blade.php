...
@if(Session::has('success'))
             ...
             @endif  
  <div class="title">LOADING STATION</div>
    ...
    <input type="hidden" name="id" value="{{$data['id']}}">
      <div class="user-details">
        ...
        <div class="input-box">
          ...
          <input class="form-control" type="number" name="vote" id="vote" value="{{$data['vote']}}" onchange="aaaa();" readonly  >
        </div>
        <div class="input-box">
      ...
      <div class="button">
        <input type="submit" value="UPDATE LOAD">
      </div>
